...
- **Shipped since:** Get*() removals, the ItemFilter move, and the concurrent + mapSyncError tests shipped in session 14; the upstream WIP is moot at go-cqrs-lite v4.9 (public).
