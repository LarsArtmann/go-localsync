...
| Command/Query middleware | Not started | Dispatchers are wired but no middleware added yet (`command.Dispatcher.Use()`, `query.Dispatcher.Use()`). This is the *point* of having dispatchers — the middleware pipeline. |
