...
Outbox + projection runner shipped same day; Turso items moot (v0.2.0); command dispatcher/middleware/LWWResolver shipped by v0.4.0; UpcasterRegistry is tracked in TODO_LIST; the upstream go-cqrs-lite items live in that repo; BDD/ginkgo ideas routed to ROADMAP 'Recurring suggestions'. No live items remain.
