...
Stack split + middleware shipped same day (see the 00-35/00-55 reports); Turso items moot (v0.2.0); LWWResolver wired 2026-05-29; second-provider idea routed to ROADMAP; OTel tracked in TODO_LIST; benchmarks partially done (adapter/stack/readmodel benches exist; full-pipeline bench in TODO_LIST). No live items remain.
