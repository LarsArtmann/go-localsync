...
Era-closed: the Turso/LibSQL client was removed entirely — storage is now SQLite (pure-Go modernc driver) behind go-cqrs-lite storage; rename/remote-test/helper items died with it. No live items remain here; the living trackers are [TODO_LIST.md](../../../TODO_LIST.md) and [ROADMAP.md](../../../ROADMAP.md).
