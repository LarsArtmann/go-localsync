...
8. ~~**TODO_LIST growth policy**: this sweep took the list 3 → 27 open items. Bounded and cited, yes — but a list that just reached zero growing 9× in one sweep deserves an explicit owner preference (cap? tiering? ROADMAP-first?). See §g.~~ done (routed to owner — TODO_LIST rebuilt to 26 cited open items; count corrected 2026-09-06 17:02, originally miswritten as 28)
