...
Command/query middleware + stack split shipped same day; Turso items moot (v0.2.0); tagging items superseded by the v2-v4 major model; OTel tracked in TODO_LIST. No live items remain.
