...
Era-closed: the entire SQL layer this report fixed (sqlc, migrations, go-localfirst replace directives, `github_id` column) was deleted by the 2026-05-03 CQRS rewrite ([ADR-0001](../../adr/0001-cqrs-adoption.md)). Conflict detection itself → shipped in the decider (ContentHash-first, ADR-0007). No live items remain here; the living trackers are [TODO_LIST.md](../../../TODO_LIST.md) and [ROADMAP.md](../../../ROADMAP.md).
