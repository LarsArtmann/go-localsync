...
Coverage-sprint fixes shipped same day; Turso/Push-Pull items moot (v0.2.0); CI/dispatcher/middleware items shipped by v0.4.0; OTel is tracked in TODO_LIST. No live items remain.
