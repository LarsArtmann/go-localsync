...
_~~_Still open:__ OpenTelemetry wiring, API auth/rate-limiting, making `go-cqrs-lite` public. See TODO_LIST.md.~~ → all three shipped — OTel (M05), auth/rate-limit (M12/M13), go-cqrs-lite public (2026-09-05)
