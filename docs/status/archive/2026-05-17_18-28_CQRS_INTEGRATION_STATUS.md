...
Consolidation shipped the same day (see 2026-05-17_19-28_POST-CONSOLIDATION.md). Turso Push/Pull framing is moot (deleted in the v0.2.0 migration); the doc-sync and taxonomy items shipped (error overhaul v0.4.0); 'projection.Runner' superseded by projectionhost (v0.4.0); go-cqrs-lite items belong to that repo, not this backlog. No live items remain here.
