...
> latent bugs. Doing these _first_ prevents cascading rework later.
...
| 1.1b | Add test asserting _all_ field errors surface in one call  | New `TestValidate_AllErrors` table case with empty item         | `go test ./pkg/data/model/` |
