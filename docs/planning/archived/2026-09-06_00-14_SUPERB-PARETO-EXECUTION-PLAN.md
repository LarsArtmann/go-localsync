...
**Sources of truth:** [TODO_LIST.md](../../../TODO_LIST.md) (56 open items, all code-verified 2026-09-05), the [23:58 docs-health sweep](../../status/archive/2026-09-05_23-58_DOCS-HEALTH-FULL-SWEEP-ANNOTATE-ARCHIVE.md), the concurrent [23:04 report](../../status/archive/2026-09-05_23-04_TODO-SWEEP-RELEASE-LINT-TOOLING-STATUS.md), [ROADMAP.md](../../../ROADMAP.md). Every task below cites its source; nothing here is new scope beyond the 4 items added to TODO_LIST during planning (docs-policy cluster, ROADMAP export-row cleanup, cluster IDs).
