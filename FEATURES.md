...
| #  | Feature      | Status           | Package        | Description                                                                                                                                        |
| -- | ------------ | ---------------- | -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| 55 | Test Suite   | FULLY_FUNCTIONAL | all            | 313 test functions across 11 packages (plus 31 in the standalone `provider/github` module), all passing race-clean. Run: `go test ./... -count=1`. |
...
- 313 tests across 11 packages, plus 31 in `provider/github` (race-clean); pkg/cqrs ≥87% coverage, gated by CI
