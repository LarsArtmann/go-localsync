...
- **CIE-L\*C\*h° (HCL):** This is generally the [most useful](http://vis4.net/blog/posts/avoid-equidistant-hsv-colors/) one; CIE-L\*a\*b\* space in polar coordinates, i.e. a _better_ HSV. H° is in [0..360], C\* almost in [0..1] and L\* as in CIE-L\*a\*b\*.
...
A coordinate being _almost in_ a range means that generally it is, but for very
...
In the RGB color space, the Euclidean distance between colors _doesn't_ correspond
