...
**Important:** When making a change, you usually need to update _both_ code paths (the musl path and the hand-written path).
...
- _Note: `libc.membrk` and `libc.memgrind` are mutually exclusive._
