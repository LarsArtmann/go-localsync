...
func _getFileMode(tls *libc.TLS, zFile, pMode, pUid, pGid uintptr) (r int32) {
	...
	if 0 == (*(*func(*libc.TLS, uintptr, uintptr) int32)(unsafe.Pointer(&struct{ uintptr }{_aSyscall[int32(4)].FpCurrent})))(tls, zFile, bp) {
		**(**Tmode_t)(__ccgo_up(pMode)) = libc.Uint16FromInt32(libc.Int32FromUint16((**(**Tstat)(__ccgo_up(bp))).Fst_mode) & int32(0o777))
...
func _robust_open(tls *libc.TLS, z uintptr, f int32, m Tmode_t) (r int32) {
	...
	if fd >= 0 {
		if libc.Int32FromUint16(m) != 0 {
			if (*(*func(*libc.TLS, int32, uintptr) int32)(unsafe.Pointer(&struct{ uintptr }{_aSyscall[int32(5)].FpCurrent})))(tls, fd, bp) == 0 && (**(**Tstat)(__ccgo_up(bp))).Fst_size == 0 && libc.Int32FromUint16((**(**Tstat)(__ccgo_up(bp))).Fst_mode)&int32(0o777) != libc.Int32FromUint16(m) {
...
func _unixAccess(tls *libc.TLS, NotUsed, zPath uintptr, flags int32, pResOut uintptr) (r int32) {
	...
	if flags == SQLITE_ACCESS_EXISTS {
		**(**int32)(__ccgo_up(pResOut)) = libc.BoolInt32(0 == (*(*func(*libc.TLS, uintptr, uintptr) int32)(unsafe.Pointer(&struct{ uintptr }{_aSyscall[int32(4)].FpCurrent})))(tls, zPath, bp) && (!(libc.Int32FromUint16((**(**Tstat)(__ccgo_up(bp))).Fst_mode)&libc.Int32FromInt32(0o170000) == libc.Int32FromInt32(0o100000)) || (**(**Tstat)(__ccgo_up(bp))).Fst_size > 0))
	} else {
