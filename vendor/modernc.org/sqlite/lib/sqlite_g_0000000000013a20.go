...
//	*/
func Xsqlite3_create_filename(tls *libc.TLS, zDatabase, zJournal, zWal uintptr, nParam int32, azParam uintptr) (r uintptr) {
	var i int32
...
//	*/
func _codeAllEqualityTerms(tls *libc.TLS, pParse, pLevel uintptr, bRev, nExtraReg int32, pzAff uintptr) (r int32) {
...
//	*/
func _computeIndexAffStr(tls *libc.TLS, db, pIdx uintptr) (r uintptr) {
	var aff uint8
	var n int32
	var pTab uintptr
	var x Ti16
...
//	** insert.
//	*/
func _constInsert(tls *libc.TLS, pConst, pColumn, pValue, pExpr uintptr) {
	var i int32
	var pE2 uintptr
	_, _ = i, pE2
...
//	*/
func _exprAnalyzeOrTerm(tls *libc.TLS, pSrc, pWC uintptr, idxTerm int32) {
...
//	*/
func _exprINAffinity(tls *libc.TLS, pParse, pExpr uintptr) (r uintptr) {
	var a uint8
	var i, nVal int32
...
//	*/
func _fts5ConfigGobbleWord(tls *libc.TLS, pRc, zIn, pzOut, pbQuoted uintptr) (r uintptr) {
	var ii int32
...
func _fts5PorterCb(tls *libc.TLS, pCtx uintptr, tflags int32, pToken uintptr, nToken, iStart, iEnd int32) (r int32) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
	var aBuf, p uintptr
	var c uint8
...
//	*/
func _fts5TriTokenize(tls *libc.TLS, pTok, pCtx uintptr, unusedFlags int32, pText uintptr, nText int32, __ccgo_fp_xToken uintptr) (r int32) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	var aStart [3]int32
	var iCode Tu32
...
func _fts5UnicodeTokenize(tls *libc.TLS, pTokenizer, pCtx uintptr, iUnused int32, pText uintptr, nText int32, __ccgo_fp_xToken uintptr) (r int32) {
...
//	*/
func _geopolyParseJson(tls *libc.TLS, z, pRc uintptr) (r uintptr) {
	bp := tls.Alloc(48)
	defer tls.Free(48)
...
//	*/
func _indexInAffinityOk(tls *libc.TLS, pParse, pTerm uintptr, idxaff Tu8) (r uintptr) {
	bp := tls.Alloc(80)
	defer tls.Free(80)
	var iField int32
...
//	** the operator.
//	*/
func _isLikeOrGlob(tls *libc.TLS, pParse, pExpr, ppPrefix, pisComplete, pnoCase uintptr) (r int32) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	var c, v1 Tu8
...
//	*/
func _jsonAppendString(tls *libc.TLS, p, zIn uintptr, N Tu32) {
	var c Tu8
	var k Tu32
	var z, v2 uintptr
	var v1 Tu64
...
//	*/
func _jsonCreateEditSubstructure(tls *libc.TLS, pParse, pIns, zTail uintptr) (r Tu32) {
	var rc int32
	var v1 uintptr
	_, _ = rc, v1
...
func _jsonEachColumn(tls *libc.TLS, cur, ctx uintptr, iColumn int32) (r int32) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
	var eType Tu8
...
//	*/
func _memdbOpen(tls *libc.TLS, pVfs, zName, pFd uintptr, flags int32, pOutFlags uintptr) (r int32) {
...
//	** size.
//	*/
func _pager_delsuper(tls *libc.TLS, pPager, zSuper uintptr) (r int32) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
...
//	*/
func _patternCompare(tls *libc.TLS, _zPattern, _zString, pInfo uintptr, matchOther Tu32) (r int32) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
...
//	**     pWalker->u.pConst.
//	*/
func _propagateConstantExprRewrite(tls *libc.TLS, pWalker, pExpr uintptr) (r int32) {
	var pConst uintptr
	_ = pConst
...
//	** is SQLITE_AFF_BLOB.
//	*/
func _propagateConstantExprRewriteOne(tls *libc.TLS, pConst, pExpr uintptr, bIgnoreAffBlob int32) (r int32) {
	var i int32
	var pColumn uintptr
	_, _ = i, pColumn
	if **(**Tu8)(__ccgo_up((*TWhereConst)(unsafe.Pointer(pConst)).FpOomFault)) != 0 {
...
//	*/
func _readSuperJournal(tls *libc.TLS, pJrnl, zSuper uintptr, nSuper Tu64) (r int32) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
...
//	** excepted.)
//	*/
func _resolveOrderGroupBy(tls *libc.TLS, pNC, pSelect, pOrderBy, zType uintptr) (r int32) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
...
//	*/
func _sqlite3AddCheckConstraint(tls *libc.TLS, pParse, pCheckExpr, zStart, zEnd uintptr) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
	var db, pTab uintptr
...
//	*/
func _sqlite3ColumnDefault(tls *libc.TLS, v, pTab uintptr, i, iReg int32) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
	var enc Tu8
	var pCol uintptr
...
//	*/
func _sqlite3DbSpanDup(tls *libc.TLS, db, zStart, zEnd uintptr) (r uintptr) {
	var n int32
	_ = n
...
//	*/
func _sqlite3ExprCodeGeneratedColumn(tls *libc.TLS, pParse, pTab, pCol uintptr, regOut int32) {
...
//	*/
func _sqlite3ExprCodeIN(tls *libc.TLS, pParse, pExpr uintptr, destIfFalse, destIfNull int32) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
...
//	*/
func _sqlite3ExprCollSeq(tls *libc.TLS, pParse, pExpr uintptr) (r uintptr) {
...
//	**    iif(x,y,false)
//	*/
func _sqlite3ExprIsIIF(tls *libc.TLS, db, pExpr uintptr) (r int32) {
...
//	*/
func _sqlite3FindFunction(tls *libc.TLS, db, zName uintptr, nArg int32, enc, createFlag Tu8) (r uintptr) {
...
//	**   + Close parenthesis - ")"
//	*/
func _sqlite3Fts5ConfigParseRank(tls *libc.TLS, zIn, pzRank, pzRankArgs uintptr) (r int32) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
...
//	** code.
//	*/
func _sqlite3Fts5ExprPattern(tls *libc.TLS, pConfig uintptr, bGlob, iCol int32, zText, pp uintptr) (r int32) {
	var aSpec [3]uint8
...
//	*/
func _sqlite3Fts5HashWrite(tls *libc.TLS, pHash uintptr, iRowid Ti64, iCol, iPos int32, bByte uint8, pToken uintptr, nToken int32) (r int32) {
...
//	*/
func _sqlite3Fts5Strndup(tls *libc.TLS, pRc, pIn uintptr, nIn int32) (r uintptr) {
	var zRet uintptr
	_ = zRet
	zRet = uintptr(0)
...
//	*/
func _sqlite3GetInt32(tls *libc.TLS, zNum, pValue uintptr) (r int32) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
...
//	** false.
//	*/
func _sqlite3IsLikeFunction(tls *libc.TLS, db, pExpr, pIsNocase, aWc uintptr) (r int32) {
	var nExpr int32
...
//	*/
func _sqlite3IsShadowTableOf(tls *libc.TLS, db, pTab, zName uintptr) (r int32) {
	var nName int32
	var pMod uintptr
...
//	*/
func _sqlite3MarkAllShadowTablesOf(tls *libc.TLS, db, pTab uintptr) {
...
//	*/
func _sqlite3ResultSetOfSelect(tls *libc.TLS, pParse, pSelect uintptr, aff uint8) (r uintptr) {
	var db, pTab uintptr
	var savedFlags Tu64
...
//	*/
func _sqlite3Stat4ProbeSetValue(tls *libc.TLS, pParse, pIdx, ppRec, pExpr uintptr, nElem, iVal int32, pnExtract uintptr) (r int32) {
	bp := tls.Alloc(48)
	defer tls.Free(48)
	var aff Tu8
...
//	** the space when done.
//	*/
func _sqlite3TableAffinityStr(tls *libc.TLS, db, pTab uintptr) (r uintptr) {
	var i, j, v2, v3 int32
	var zColAff uintptr
...
//	*/
func _sqlite3VListAdd(tls *libc.TLS, db, pIn, zName uintptr, nName, iVal int32) (r uintptr) {
	var i, nInt int32
...
//	*/
func _sqlite3VListNameToNum(tls *libc.TLS, pIn, zName uintptr, nName int32) (r int32) {
	var i, mx int32
	var z uintptr
	_, _, _ = i, mx, z
	if pIn == uintptr(0) {
...
//	** %-conversion extensions.
//	*/
func _sqlite3VMPrintf(tls *libc.TLS, db, zFormat uintptr, ap Tva_list) (r uintptr) {
	bp := tls.Alloc(112)
	defer tls.Free(112)
	var z uintptr
	var _ /* acc at bp+72 */ TStrAccum
...
//	*/
func _sqlite3VdbeMemSetStr(tls *libc.TLS, pMem, z uintptr, n Ti64, enc Tu8, __ccgo_fp_xDel uintptr) (r int32) {
	var flags Tu16
	var iLimit, v2 int32
...
//	*/
func _sqlite3VdbeMemSetText(tls *libc.TLS, pMem, z uintptr, n Ti64, __ccgo_fp_xDel uintptr) (r int32) {
	var flags Tu16
	var nAlloc, nByte Ti64
	var v1 int64
...
//	*/
func _sqlite3WindowCodeInit(tls *libc.TLS, pParse, pSelect uintptr) {
...
//	*/
func _sqlite3WindowRewrite(tls *libc.TLS, pParse, p uintptr) (r int32) {
	bp := tls.Alloc(64)
	defer tls.Free(64)
...
//	** index existed.
//	*/
func _termCanDriveIndex(tls *libc.TLS, pTerm, pSrc uintptr, notReady TBitmask) (r int32) {
	var aff uint8
	var leftCol int32
	_, _ = aff, leftCol
...
//	** to run faster.
//	*/
func _vdbeColumnFromOverflow(tls *libc.TLS, pC uintptr, iCol int32, t Tu32, iOffset Ti64, cacheStatus, colCacheCtr Tu32, pDest uintptr) (r int32) {
...
//	*/
func _whereAddIndexedExpr(tls *libc.TLS, pParse, pIdx uintptr, iIdxCur int32, pTabItem uintptr) {
	var i, j int32
...
//	** by a constant.
//	*/
func _wherePartIdxExpr(tls *libc.TLS, pParse, pIdx, pPart, pMask uintptr, iIdxCur int32, pItem uintptr) {
	var aff Tu8
	var bNullRow int32
...
//	** SQLITE_OK.
//	*/
func _whereRangeSkipScanEst(tls *libc.TLS, pParse, pLower, pUpper, pLoop, pbDone uintptr) (r int32) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	var aff Tu8
...
//	*/
func _writeSuperJournal(tls *libc.TLS, pPager, zSuper uintptr) (r int32) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
	var cksum Tu32
	var iHdrOff Ti64
...
//	*/
func _xferOptimization(tls *libc.TLS, pParse, pDest, pSelect uintptr, onError, iDbDest int32) (r int32) {
