...
| ------------------- | ----- | -------- | -------------------------------------------------------------------------------------------------------------------------------- |
| `pkg/cqrs`          | 154   | 87.7%    | ✅ Decider, ReadModel, Projection, Stack, SQLite RM, Replay, Correlation, tombstone, upcasting, scenario specs, regression tests |
