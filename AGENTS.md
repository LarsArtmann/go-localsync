...
- `decider.go` — `SyncItemState{Item *provider.Item, Deleted bool}`, pure Apply (the event applier) + DecideSync/DecideDelete, `HasChanged` checks UpdatedAt/Type/ActorLogin/RepoName/RepoURL
