...
// Reader defines read-only operations on stored items.
// All implementations must satisfy the read contracts documented on each method.
//
...
// Storage defines the full interface for storing and retrieving sync items.
// It is composed of Reader, Writer, and Closer for fine-grained dependency injection.
//
// # Interface Contracts
//
